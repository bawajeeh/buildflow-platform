      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-1 bg-gray-100 rounded-lg p-0.5">
            ...
            <button
              onClick={onZoomReset}
              className="px-2 text-xs font-medium text-gray-600 hover:text-gray-900 hover:bg-white rounded"
              title="Reset Zoom"
          ...
          <div className="flex items-center space-x-1 ml-2">
            <button
              ...
              className={cn('px-2 py-1 text-xs rounded border', gridOn ? 'bg-white border-gray-300 text-gray-900' : 'bg-gray-100 text-gray-600 border-transparent hover:bg-white')}
              title="Toggle Grid"
            >Grid</button>
            <button
              onClick={onToggleRulers}
              className={cn('px-2 py-1 text-xs rounded border', rulersOn ? 'bg-white border-gray-300 text-gray-900' : 'bg-gray-100 text-gray-600 border-transparent hover:bg-white')}
              title="Toggle Rulers"
            >Rulers</button>
          </div>
        </div>
